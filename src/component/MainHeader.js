        ...
        <div>
            <header className="relative h-screen bg-cover bg-center" style={{ backgroundImage: `url(${heroImage})` }}>
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <Link to="shop" className='xl:w-1/6 border-2 text-center mt-10 p-2 rounded-md border-white z-10 text-white hover:bg-pink-400 hover:border-transparent'>Shop Now</Link>
                </div>
            </header>
        </div>
    )
